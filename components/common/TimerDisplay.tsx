...
const TimerDisplay = ({ formattedTime, recording, isCompact }: TimerDisplayProps) => {
  ...
  return (
    <div className="flex lg:w-full lg:justify-between p-2 bg-base-200/40 rounded-2xl border border-base-300">
        ...
        <div className="flex items-center justify-center lg:gap-3">
          <div className="flex items-center gap-2">
            {recording ? (
              <div className="flex items-center gap-2">
                ...
                <span className="hidden lg:block text-error font-medium">
                  Recording
                </span>
              </div>
            ) : (
              <div className="flex items-center gap-2">
                ...
                <span className="hidden text-sm lg:block opacity-70">
                  Ready to record
                </span>
              </div>
            )}
          ...
          <div
            className={`font-mono text-sm  lg:text-lg font-bold px-2 lg:px-3 lg:py-1 rounded transition-colors ${
              recording ? 'text-error bg-error/10' : 'text-base-content bg-base-100/60'
            }`}
          >
            {formattedTime}
          </div>
